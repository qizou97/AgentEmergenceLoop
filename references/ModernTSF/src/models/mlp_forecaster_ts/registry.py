"""Model registration for MLPForecasterTS."""

from benchmark.registry import MODEL_REGISTRY
from models.mlp_forecaster_ts.model import Model
from models.mlp_forecaster_ts.schema import ModelParameterConfig


def register() -> None:
    """Register MLPForecasterTS model factory and parameter schema."""

"""Model registration for LSTMForecasterTS."""

from benchmark.registry import MODEL_REGISTRY
from models.lstm_forecaster_ts.model import Model
from models.lstm_forecaster_ts.schema import ModelParameterConfig


def register() -> None:
    """Register LSTMForecasterTS model factory and parameter schema."""

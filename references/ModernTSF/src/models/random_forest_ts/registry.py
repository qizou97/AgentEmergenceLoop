"""Model registration for RandomForestTS."""

from benchmark.registry import MODEL_REGISTRY
from models.random_forest_ts.model import Model
from models.random_forest_ts.schema import ModelParameterConfig


def register() -> None:
    """Register RandomForestTS model factory and parameter schema."""

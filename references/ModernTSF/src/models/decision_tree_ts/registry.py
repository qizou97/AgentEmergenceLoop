"""Model registration for DecisionTreeTS."""

from benchmark.registry import MODEL_REGISTRY
from models.decision_tree_ts.model import Model
from models.decision_tree_ts.schema import ModelParameterConfig


def register() -> None:
    """Register DecisionTreeTS model factory and parameter schema."""

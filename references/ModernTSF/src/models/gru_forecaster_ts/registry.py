"""Model registration for GRUForecasterTS."""

from benchmark.registry import MODEL_REGISTRY
from models.gru_forecaster_ts.model import Model
from models.gru_forecaster_ts.schema import ModelParameterConfig


def register() -> None:
    """Register GRUForecasterTS model factory and parameter schema."""

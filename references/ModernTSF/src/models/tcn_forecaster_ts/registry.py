"""Model registration for TCNForecasterTS."""

from benchmark.registry import MODEL_REGISTRY
from models.tcn_forecaster_ts.model import Model
from models.tcn_forecaster_ts.schema import ModelParameterConfig


def register() -> None:
    """Register TCNForecasterTS model factory and parameter schema."""

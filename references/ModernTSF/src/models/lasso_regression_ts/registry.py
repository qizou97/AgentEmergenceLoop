"""Model registration for LassoRegressionTS."""

from benchmark.registry import MODEL_REGISTRY
from models.lasso_regression_ts.model import Model
from models.lasso_regression_ts.schema import ModelParameterConfig


def register() -> None:
    """Register LassoRegressionTS model factory and parameter schema."""

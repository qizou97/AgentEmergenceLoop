"""Model registration for GradientBoostingTS."""

from benchmark.registry import MODEL_REGISTRY
from models.gradient_boosting_ts.model import Model
from models.gradient_boosting_ts.schema import ModelParameterConfig


def register() -> None:
    """Register GradientBoostingTS model factory and parameter schema."""

"""Model registration for RidgeRegressionTS."""

from benchmark.registry import MODEL_REGISTRY
from models.ridge_regression_ts.model import Model
from models.ridge_regression_ts.schema import ModelParameterConfig


def register() -> None:
    """Register RidgeRegressionTS model factory and parameter schema."""

"""Model registration for BayesianRidgeTS."""

from benchmark.registry import MODEL_REGISTRY
from models.bayesian_ridge_ts.model import Model
from models.bayesian_ridge_ts.schema import ModelParameterConfig


def register() -> None:
    """Register BayesianRidgeTS model factory and parameter schema."""

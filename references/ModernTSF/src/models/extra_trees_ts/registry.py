"""Model registration for ExtraTreesTS."""

from benchmark.registry import MODEL_REGISTRY
from models.extra_trees_ts.model import Model
from models.extra_trees_ts.schema import ModelParameterConfig


def register() -> None:
    """Register ExtraTreesTS model factory and parameter schema."""

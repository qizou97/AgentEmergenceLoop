"""Model registration for NSTransformer (Nonstationary Transformer)."""

from benchmark.registry import MODEL_REGISTRY
from models.nstransformer.model import Model
from models.nstransformer.schema import ModelParameterConfig


def register() -> None:
    """Register NSTransformer model factory and parameter schema."""
    MODEL_REGISTRY.register(
        ...
        lambda cfg, params: Model(
            ...
            p_hidden_dims=params.get("p_hidden_dims", [128, 128]),
            p_hidden_layers=params.get("p_hidden_layers", 2),
        ),

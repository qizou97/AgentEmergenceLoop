"""Model registration for KalmanFilterTS."""

from benchmark.registry import MODEL_REGISTRY
from models.kalman_filter_ts.model import Model
from models.kalman_filter_ts.schema import ModelParameterConfig


def register() -> None:
    """Register KalmanFilterTS model factory and parameter schema."""

"""Model registration for LightGBMTS."""

from benchmark.registry import MODEL_REGISTRY
from models.lightgbm_ts.model import Model
from models.lightgbm_ts.schema import ModelParameterConfig


def register() -> None:
    """Register LightGBMTS model factory and parameter schema."""

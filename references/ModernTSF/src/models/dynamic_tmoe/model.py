"""ModernTSF adapter for DynamicTMoE.

This lightweight implementation follows the ModernTSF forecasting interface and
captures the main inductive bias of the verified open-source ICML 2026
time-series forecasting work without vendoring its full training harness.
Upstream reference: https://github.com/andone-07/Dynamic-TMoE
"""

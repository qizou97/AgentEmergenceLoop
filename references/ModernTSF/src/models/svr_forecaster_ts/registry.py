"""Model registration for SVRForecasterTS."""

from benchmark.registry import MODEL_REGISTRY
from models.svr_forecaster_ts.model import Model
from models.svr_forecaster_ts.schema import ModelParameterConfig


def register() -> None:
    """Register SVRForecasterTS model factory and parameter schema."""

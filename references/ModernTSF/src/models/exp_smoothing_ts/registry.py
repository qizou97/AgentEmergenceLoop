"""Model registration for ExpSmoothingTS."""

from benchmark.registry import MODEL_REGISTRY
from models.exp_smoothing_ts.model import Model
from models.exp_smoothing_ts.schema import ModelParameterConfig


def register() -> None:
    """Register ExpSmoothingTS model factory and parameter schema."""

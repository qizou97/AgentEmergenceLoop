"""Model registration for CatBoostTS."""

from benchmark.registry import MODEL_REGISTRY
from models.catboost_ts.model import Model
from models.catboost_ts.schema import ModelParameterConfig


def register() -> None:
    """Register CatBoostTS model factory and parameter schema."""

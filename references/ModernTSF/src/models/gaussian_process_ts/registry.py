"""Model registration for GaussianProcessTS."""

from benchmark.registry import MODEL_REGISTRY
from models.gaussian_process_ts.model import Model
from models.gaussian_process_ts.schema import ModelParameterConfig


def register() -> None:
    """Register GaussianProcessTS model factory and parameter schema."""

"""Model registration for Informer."""

from benchmark.registry import MODEL_REGISTRY
from models.informer.model import Model
from models.informer.schema import ModelParameterConfig


def register() -> None:
    """Register Informer model factory and parameter schema."""
    MODEL_REGISTRY.register(
        ...
        lambda cfg, params: Model(
            ...
            distil=bool(params.get("distil", True)),

"""Model registration for ElasticNetTS."""

from benchmark.registry import MODEL_REGISTRY
from models.elastic_net_ts.model import Model
from models.elastic_net_ts.schema import ModelParameterConfig


def register() -> None:
    """Register ElasticNetTS model factory and parameter schema."""

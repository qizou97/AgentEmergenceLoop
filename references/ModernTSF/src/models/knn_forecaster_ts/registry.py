"""Model registration for KNNForecasterTS."""

from benchmark.registry import MODEL_REGISTRY
from models.knn_forecaster_ts.model import Model
from models.knn_forecaster_ts.schema import ModelParameterConfig


def register() -> None:
    """Register KNNForecasterTS model factory and parameter schema."""

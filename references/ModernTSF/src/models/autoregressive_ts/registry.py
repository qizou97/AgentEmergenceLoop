"""Model registration for AutoRegressiveTS."""

from benchmark.registry import MODEL_REGISTRY
from models.autoregressive_ts.model import Model
from models.autoregressive_ts.schema import ModelParameterConfig


def register() -> None:
    """Register AutoRegressiveTS model factory and parameter schema."""

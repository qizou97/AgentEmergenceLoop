"""Model registration for RNNForecasterTS."""

from benchmark.registry import MODEL_REGISTRY
from models.rnn_forecaster_ts.model import Model
from models.rnn_forecaster_ts.schema import ModelParameterConfig


def register() -> None:
    """Register RNNForecasterTS model factory and parameter schema."""

"""Kolmogorov-Arnold Network layers used by DTAF.

Vendored from https://github.com/decisionintelligence/DTAF
(ts_benchmark/baselines/dtaf/layer/kan.py). The DTAF repository ships no
explicit LICENSE file; it is published by the decisionintelligence group as a
